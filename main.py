...
print(train_data[0])
#display data, and mapoing words this give us dictionary
...
model.add(keras.layers.Embedding(10000, 16)) #math group, great = good like one the same word
